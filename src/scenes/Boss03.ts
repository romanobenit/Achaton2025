...
export default class Boss03 extends Phaser.Scene {
  ...
  create() {
    ...
    this._player = new Player({
      ...
      { nome: "God's Touch", danno: 125, costo: 5 }
    ]);
    ...
    let _nomeBoss: Phaser.GameObjects.Text = this.add.text(20, 10, "Abyssman", {fontFamily: "Underdog", fontSize: 40, color: "#770000"}).setDepth(1000);
